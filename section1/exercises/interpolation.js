...
// Your answer and explanation here: This is a string data type because it is combining two strings into one value or string.
...
console.log( `Something you could find in ${location}, are ${animal}s doing ${activity} for fun. `);
