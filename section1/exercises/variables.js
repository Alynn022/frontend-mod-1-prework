...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// I decided on my name for the first variable, the syntax for a string is (single or double)
//quotes. The second variable I decided to use a boolean because the variable is like a question,
//and you can only have a true or false answer. The third variable, I decided on an
//integer because the name of the variable is numberOfPets, emphasis on number.
